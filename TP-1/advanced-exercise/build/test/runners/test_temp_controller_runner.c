...
extern void test_check_temperature_should_return_error_on_sensor_failure(void);
...
int main(void)
{
  ...
  run_test(test_check_temperature_should_return_error_on_sensor_failure, "test_check_temperature_should_return_error_on_sensor_failure", 43);
