...
void test_invalid_sensor_value_workflow(void) {
    ...
    for (int i = 0; i < 20; i++) {
        ...
        if (!is_valid_value(sensor_value)) {
            ...
            do {if (!(is_valid_value(sensor_value))) {} else {UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((UNITY_UINT)(32)));}} while(0);
    ...
    for (int i = 0; i < sizeof(boundary_values) / sizeof(boundary_values[0]); i++) {
        ...
        if (is_valid_value(sensor_value)) {
           ...
           ((void *)0)
            ...
            do {if (!(is_valid_value(sensor_value))) {} else {UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((UNITY_UINT)(48)));}} while(0);
