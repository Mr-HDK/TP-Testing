...
Test Spécifique Température 45°C
    ...
    ${temperature}=    Convert To Number    ${temperature}   # S'assurer que la température est un entier
    ...
    Run Keyword If    ${temperature} >= 0 and ${temperature} <= 100    Log    Pas de notification nécessaire pour ${temperature}°C
